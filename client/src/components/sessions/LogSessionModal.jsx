      ...
      >
        ...
        <div className="px-5 py-5 space-y-5">
          ...
          <div className="bg-stone-50 rounded-2xl p-4 text-center">
            <div className="text-5xl font-mono font-medium text-stone-900 mb-4 tracking-tight">
            ...
            <div className="flex gap-4">
              {[1, 2, 3, 4, 5].map((n) => (
                <button
                  ...
                  className={`text-3xl transition-transform touch-manipulation active:scale-90 ${form.overall_feel === n ? "scale-125 drop-shadow-sm" : "opacity-60"}`}
                >
                  {FEEL_EMOJI[n]}
                </button>
              ))}
